    ...
    >
      ...
      <LSection id="plans-billing" title="3. Plans and billing">
        <LUl>
          ...
          <li><strong>Wirby Plus:</strong> a paid monthly subscription billed in advance through our merchant of record, Lemon Squeezy (Lemon Squeezy, Inc.). Lemon Squeezy is the seller of record for the purchase and handles applicable sales tax/VAT. Pricing is shown on the <Link to="/pricing" className="text-pine-700 underline hover:no-underline">Pricing page</Link> and may change with notice; changes apply from your next billing cycle.</li>
          <li>Subscriptions renew automatically each billing period until cancelled.</li>
          <li>You can cancel anytime from Settings via Lemon Squeezy's customer portal. Cancelling stops future renewals; see our <Link to="/refund-policy" className="text-pine-700 underline hover:no-underline">Refund Policy</Link> for what happens to the current billing period.</li>
      ...
      <LSection id="third-party" title="7. Third-party services">
        <LP>
          Payments for Wirby Plus are handled by Lemon Squeezy, which acts as
          the merchant of record and seller of record — Lemon Squeezy, not
          Wirby, is who you are billed by, and it handles applicable sales
          tax/VAT on the purchase. Core infrastructure is provided by Supabase,
          and transactional email by Resend. Each operates under its own
          respective terms. We are not responsible for outages or issues
          originating from these third-party providers, though we will work to
          restore the Service as quickly as we reasonably can.
        </LP>
      </LSection>
